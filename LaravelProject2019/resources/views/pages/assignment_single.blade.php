...
@section ('content')
    ...
    <section id="logo" class="tm-section-logo mt-5">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-12 offset-sm-0 col-md-6" style="background-color: #FFF !important; border-radius: 2px;">
    ...
    <section id="intro" class="tm-p-1-section-1" style="">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6" style="background-color:#FFF !important; border-radius:2px;">
    ...
    <section id="section_4" class="tm-section-4">
        <div class="container-fluid">
            <div class="row flex-column-reverse flex-lg-row">
                <div class="col-md-12 col-lg-6 tm-text-left-container" style="background-color: #000 !important; padding-top: 10px; padding-bottom: 10px;">
                    <div class="tm-section-text-container-3 tm-bg-white-alpha h-100">
                        ...
                        @endif
                        <a href="/blog-filter?assignment_id={{$assignment->id}}" class="btn btn-danger">See Blogposts</a>
                ...
                <div
                        class="col-md-12 col-lg-6 tm-section-image-container tm-img-right-container" style="background-color: #000; padding-left: 0px; padding-right:0px;"
                >
                    {{--<img--}}
